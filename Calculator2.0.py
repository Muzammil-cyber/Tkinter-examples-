...
Bmultiple = Button(main, text="X", width=10, command=lambda: Sign("*"))
Bdivide = Button(main, text="/", width=10, command=lambda: Sign("/"))
Bequal = Button(main, text="=", width=10, command=Display)
BCE = Button(main, text="CE", width=10, command=Clearone)
Bclear = Button(main, text="Clear", width=10, command=CLEAR)

Bclear.grid(row=1, column=0)
BCE.grid(row=1, column=1)
